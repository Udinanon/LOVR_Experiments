...
vec4 lovrmain() {
  ...
  float snd0 = getPixel(sound, vec2(u * 1., 0)).a;
  float snd1 = getPixel(sound, vec2(u * 0.5, 0)).a;
  float snd2 = getPixel(sound, vec2(u * 0.25, 0)).a;
  float snd3 = getPixel(sound, vec2(u * 0.125, 0)).a;
